...
exports.sourceNodes = async ({ actions }) => {
  ...
  const baseUrl = "https://www-loadbal4.linode.com/wp-json/menus/v1/menus";
  const wpMenus = [
    {
    ...
    {
      path: `${baseUrl}/submenu-solutions-all`,
      name: "SolutionsAll"
    },
        {
      path: `${baseUrl}/submenu-solutions-featured`,
      name: "SolutionsFeatured"
    },
    {
