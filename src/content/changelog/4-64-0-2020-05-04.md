...
- Added the View Network Transfer (year/month) ([GET /linode/instances/{linodeId}/transfer/{year}/{month}](https://developers.linode.com/api/docs/v4#operation/getLinodeTransferByYearMonth)) endpoint.
